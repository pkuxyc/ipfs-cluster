...
func (c *Cluster) setupRPC() error {
	...
	rpcServer := rpc.NewServer(c.host, RPCProtocol, rpc.WithServerStatsHandler(sh))
	...
	rpcClient := rpc.NewClientWithServer(c.host, RPCProtocol, rpcServer, rpc.WithClientStatsHandler(csh))
