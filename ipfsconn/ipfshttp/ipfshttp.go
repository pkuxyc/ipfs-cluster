...
func NewConnector(cfg *Config) (*Connector, error) {
	...
	smux.Handle("/", ochttp.WithRouteTag(proxyHandler, "/"))
	smux.Handle("/api/v0/pin/add", ochttp.WithRouteTag(http.HandlerFunc(ipfs.pinHandler), "/api/v0/pin/add"))   // add?arg=xxx
	smux.Handle("/api/v0/pin/add/", ochttp.WithRouteTag(http.HandlerFunc(ipfs.pinHandler), "/api/v0/pin/add/")) // add/xxx
	smux.Handle("/api/v0/pin/rm", ochttp.WithRouteTag(http.HandlerFunc(ipfs.unpinHandler), "/api/v0/pin/rm"))   // rm?arg=xxx
	smux.Handle("/api/v0/pin/rm/", ochttp.WithRouteTag(http.HandlerFunc(ipfs.unpinHandler), "/api/v0/pin/rm/")) // rm/xxx
	smux.Handle("/api/v0/pin/ls", ochttp.WithRouteTag(http.HandlerFunc(ipfs.pinLsHandler), "/api/v0/pin/ls"))   // required to handle /pin/ls for all pins
	smux.Handle("/api/v0/pin/ls/", ochttp.WithRouteTag(http.HandlerFunc(ipfs.pinLsHandler), "/api/v0/pin/ls/")) // ls/xxx
	smux.Handle("/api/v0/add", ochttp.WithRouteTag(http.HandlerFunc(ipfs.addHandler), "/api/v0/add"))
	smux.Handle("/api/v0/repo/stat", ochttp.WithRouteTag(http.HandlerFunc(ipfs.repoStatHandler), "/api/v0/repo/stat"))
